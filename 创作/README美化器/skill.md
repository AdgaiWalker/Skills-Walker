...
description: >
  README 美化器——只做结构和格式层面的修复，不编造、不删内容、不改技术细节。
  当用户提到"美化 README"、"整理 README"、"README 格式乱了"、"README 排版"、
  "fix README"、"beautify README"时触发。
  也适用于 README 看起来不专业、层级混乱、代码块没标语言、列表格式不统一等场景。
  注意：这个技能只做美化，不生成新内容。生成 README 用 readme-generator。
---
